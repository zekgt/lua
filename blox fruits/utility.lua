...
do -- Example UI
	-- ADD CHEST ESP AND FRUIT ESP
    local ESP = loadstring(game:HttpGet("https://kiriot22.com/releases/ESP.lua"))()
	local Window = library:AddWindow("Mimay Blox Fruit Utilities", {
		main_color = Color3.fromRGB(41, 74, 122),
	...
	do -- Elements
        ...
        ESP.Names = false
        ESP.TeamColor = false
        ESP.ColorDynamic = true
		local Switch = Tab:AddSwitch("ESP Toggle", function(bool)
            ESP:Toggle(bool)
		end)

        Tab:AddSwitch("Players", function(bool)
            ESP.Players = bool
        end)

        Tab:AddSwitch("Boxes", function(bool)
            ESP.Boxes = bool
        end)

        Tab:AddSwitch("Tracers", function(bool)
            ESP.Tracers = bool
        end)

        Tab:AddSwitch("Names", function(bool)
            ESP.Names = bool
        end)

        Tab:AddSwitch("Use Team Colour", function(bool)
            ESP.TeamColor = bool
        end)
        --[[ESP:AddObjectListener(game.Workspace, { --game:GetService("Workspace")["Revive Fruit"]
            Recursive = true,
            Type = "Tool",
            CustomName = "Fruit",
        ...
        Tab:AddSwitch("Dropped Fruits", function(bool)
            ESP.Fruits = bool -- game:GetService("Workspace")["Spring Fruit"].EatRemote
        end)]]--
        ...
        local Drop1 = Tab:AddDropdown("Other Scripts", function(object) -- callback args: <string> selected object name
            if object == "Thunder Z Hub" then
                loadstring(game:HttpGet("https://raw.githubusercontent.com/ThunderZ-05/HUB/main/Script", true))()
            end
            if object == "Putaya Hub" then
                loadstring(game:HttpGet(("https://raw.githubusercontent.com/Putaya/HITBOXKAK/main/PutayaFree"), true))()
            end
            if object == "HoHo Hub" then
                loadstring(game:HttpGet('https://raw.githubusercontent.com/acsu123/HOHO_H/SCRIPTS/vn%20Piece%20script-obfuscated.lua', true))()
            end
            if object == "Sniper Hub" then
                loadstring(game:HttpGet('https://raw.githubusercontent.com/Xero-Trash/FullVerions/Loadmain/Loader-Sniper_78964', true))()
            end
        end)
        Drop1:Add("Thunder Z Hub")
        Drop1:Add("Putaya Hub")
        Drop1:Add("HoHo Hub")
        Drop1:Add("Sniper Hub")
        Tab:AddKeybind("Keybind", function(key)
			print(key)
		end, { -- (options are optional)
			["standard"] = Enum.KeyCode.RightShift -- Default: RightShift
		})
        Tab:AddButton("Destroy Image Gui", function()
